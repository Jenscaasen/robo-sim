...
angle_cols = ['shoulder_yaw','shoulder_pitch','elbow_pitch','wrist_pitch','wrist_roll']
...
X[:,0::2] /= 639.0   # columns 0,2,4 (all the x’s)
X[:,1::2] /= 479.0   # columns 1,3,5 (all the y’s)

# angles (-1.5 .. +1.5) → divide by 1.5  →  (-1 .. +1)
y /= 1.5
