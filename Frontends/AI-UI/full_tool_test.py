...
async def test_complete_tool_flow():
    """Test a complete tool call flow with a goodbye message"""
    ...
    messages = [{"role": "user", "content": "Please get the current joint states from the simulator and then say goodbye"}]

    try:
        print("=== Step 1: AI decides to call a tool ===")
        ...
        if response and "choices" in response and response["choices"]:
            ...
            if tool_calls:
                ...
                print("\n=== Step 2: AI responds with tool result and says goodbye ===")
...
if __name__ == "__main__":
    asyncio.run(test_complete_tool_flow())